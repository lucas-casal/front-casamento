  ...
  return (
    <>
      <main className="flex box-border h-screen flex-col items-center justify-between p-24 overflow-hidden">
        ...
        <img alt='background-image' src={BackgroundPicture1.src} className={(postModalOpen ? 'blur-md' : '') + ' fixed sm:-top-72 -right-72 460:right-0 460:-left-80 -top-10 -z-10 max-w-none sm:w-bgphoto h-full sm:h-auto sm:-left-3/4 1245:left-0 1245:w-screen 1000:-left-64 md:-left-96 1245:-top-48 10xl:-top-3/4 '} />
        ...
        <div className="select-none absolute bottom-0 sm:bottom-24 h-auto w-screen grid text-center gap-4 sm:gap-28 lg:max-w-7xl sm:w-11/12 lg:mb-0 sm:h-28 sm:grid-cols-2 lg:text-left">


          <div className='flex flex-col items-center justify-center'>

            <div
              className={(postModalOpen ? 'hidden ' : '') + "group sm:rounded-lg bg-opacity-50 bg-gradient-to-b 1000:w-2/3 text-white h-11/12 1000:h-28 to-emerald-800 from-emerald-500 w-full sm:bg-transparent sm:bg-none border-y-2 border-emerald-900 sm:border-transparent px-5 py-2 transition-colors hover:cursor-pointer hover:bg-opacity-50 hover:border-cyan-300 hover:bg-gradient-to-b  hover:text-white hover:shadow-cyan-500 hover:shadow-xl hover:to-blue-800 hover:from-green-300"}
